...
public class EqualSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public EqualSpacingItemDecoration(int spacing, int displayMode, int TopForFirstRaw) {
        this.spacing = spacing;
        this.displayMode = displayMode;
        this.TopForFirstRaw = TopForFirstRaw;
        ...
        switch (displayMode) {
            ...
            case GRID:
                if (layoutManager instanceof GridLayoutManager) {
                    ...
                    Log.e("tag8", "from Cons span =" + cols);
